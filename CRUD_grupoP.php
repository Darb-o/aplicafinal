        ...
        <div class="main">
            ...
            <div class="listaproductos">
              <div class="cardHeader">
                <h2>Grupos de productos del restaurante</h2>
                <a href="#" class="btn" id="btnnuevo">Agregar grupo</a>
              </div>
              <table id="tablaGrupos" class="table table-striped table-bordered table-condense" style="width: 100%">
