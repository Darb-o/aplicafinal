...
<body>
    <div class="contenedor">
        ...
        <div class="main">
            ...
            <div class="listaproductos">
              ...
              <table id="tablaFacturas" class="table table-striped table-bordered table-condense" style="width: 100%">
    ...
    <form action="./crearPdf.php" method="post">
        ...
        <input id="deducciones" name="deducciones" type="hidden" value="">
        <input id="subTotal" name="subTotal" type="hidden" value="">
        <input id="valor" name="valor" type="hidden" value="">
        <input type="submit" id="btnMostrar" class="btn btn-primary">
    </form>
