...
<body>
        ...
        <div class="main">
            ...
            <div class="listaproductos">
              <div class="cardHeader">
                <h2>Promociones del restaurante</h2>
                <a href="#" class="btn" id="btnnuevo">Agregar promocion</a>
              </div>
              <table id="tablaDescuentos" class="table table-striped table-bordered table-condense" style="width: 100%">
    ...
    <script type="text/javascript" src="./js/scriptPromo.js"></script>
    <script>
        //menu desplegable
